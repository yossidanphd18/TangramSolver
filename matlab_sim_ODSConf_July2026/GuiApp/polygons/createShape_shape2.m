function [V, G] = createShape_shape2(appData)
...
% end
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x3,y0] ; [x6,y0] ; [x5,y1] ; [x7,y4] ; [x3,y4] ; ...
                        [x4,y5] ; [x4,y8] ; [x2,y9] ; [x2-1/sqrt(8),y7] ; [x2,y7] ; ...
                        [x2,y6] ; [x1,y5] ; [x1,y2]] + t_xy_common;
    ...
    if(0)
        ...
        d = 0.8; 
        polyInflated = polybuffer(polyOriginal, d, 'JointType', 'miter');
        G = polyInflated.Vertices;
    end
