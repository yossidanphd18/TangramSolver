...
resultsPath = '.\Results_scale_1.0__ODS_2026\';
saveFiguresFolder = '.\Figures_1\';

challengesPath = '..\Challenges_scale_1.0\polygons\'; 
...
for i = 1:nresults
    ...
    success_misocp(i) = (ResPack_MISOCP.KPIs.success) && (misocp_err_norm <= ERR_NORM_THRESHOLD_MISOCP);
    success_ga(i) = ResPack_GA.KPIs.min_norm <= ERR_NORM_THRESHOLD_GA_SA;
    success_sa(i) = ResPack_SA.KPIs.min_norm <= ERR_NORM_THRESHOLD_GA_SA;
    solver_time_misocp(i) = ResPack_MISOCP.KPIs.etime_gurobi_opt_minutes; 

    % We forced N mins execution.
    solver_time_ga(i) = ResPack_GA.opt_duration_secs/60;
    solver_time_sa(i) = ResPack_SA.opt_duration_secs/60;
