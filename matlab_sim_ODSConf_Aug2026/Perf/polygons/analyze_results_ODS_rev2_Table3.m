...
%-----------------------------------------------------
% Analyse FT results of ODS206 benchmark1 : single-run, seed not recorded.
% Compare MISOCP vs GA and SA.
basePath = '../../__RESULTS_ODS2026/ResultsConvexSOC_rev2/MultiRun/';
inputsPath = fullfile(basePath, 'InputsData30puzzles/');

challengesPath = fullfile(inputsPath, 'Challenges_scale_1.0_30_puzzles/polygons/');
resultsPath_GASA = fullfile(inputsPath, 'Results_scale_1.0_ga_sa_30_puzzles');
resultsPath_MISOCP = fullfile(inputsPath, 'Results_scale_1.0_misocp_30_puzzles');

analysisPath = fullfile(basePath, 'ResultsAnalysis/');
saveFiguresFolder = fullfile(analysisPath, 'Figures_ODS2026_rev2_30_puzzles');
...
table_txt_filename = 'ODS_Rev2_Table3_30_puzzles.txt';
table_mat_filename = 'ODS_Rev2_Table3_30_puzzles.mat';
...
function [ResPacks, SolPacks] = loadResultsGASA(resultPuth, solver_type, TImages, CountsDB, nrounds, flag_no_rounds)
