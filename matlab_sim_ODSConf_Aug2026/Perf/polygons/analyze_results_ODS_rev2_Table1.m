...
basePath = '../../__RESULTS_ODS2026/ResultsConvexSOC_rev2/SingleRun/';
inputsPath = fullfile(basePath, 'InputData/');

challengesPath = fullfile(inputsPath, 'Challenges_scale_1.0_RemovedNonConvexV1/polygons/');
resultsPath_GASA = fullfile(inputsPath, 'PAPER_REV2__Results_scale_1.0_ODS_2026_Rev1_50puzzles_GASA_MISOCP_1Run');
resultsPath_MISOCP = fullfile(inputsPath, 'PAPER_REV2__Results_scale_1.0_ConvexSoc_50puzzles_MISOCP_1Run');
...
table_txt_filename = 'ODS_Rev2_Table1.txt';
table_mat_filename = 'ODS_Rev2_Table1.mat';
