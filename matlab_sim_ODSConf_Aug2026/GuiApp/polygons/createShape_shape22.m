function [V, G, H, Gi, Gd] = createShape_shape22(appData)
    ...
    theta_deg = 180;
    txy = scale_factor * [x4+1/4,y5] + t_xy_common;
    h = (1/4)*scale_factor; w = (1/2)*scale_factor;
    area = (0.5*h*w);
    flip_agnostic = 1;
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x2,y0] ; [x6,y0] ; [x4,y1] ; [x5,y1] ; [x5,y2] ; ...
                        [x8,y2] ; [x7,y4] ; ...
                        [x8-3/4,y3] ; [x8-3/4,y5] ; [x8-3/4-1/2,y5] ; [x4,y4] ; [x4-1/4,y3] ; ...
                        [x1,y4] ; [x0,y2] ; [x3,y2] ; ... 
                        [x3,y1] ; [x4,y1] ] + t_xy_common;
