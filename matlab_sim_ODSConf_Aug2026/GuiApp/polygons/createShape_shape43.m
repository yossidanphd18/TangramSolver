function [V, G, H, Gi, Gd] = createShape_shape43(appData)
    ...
    theta_deg = 45;
    txy = scale_factor * [x01,y3] + t_xy_common;
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x0,y0] ; [x1,y0] ; [x1,y1] ; [x3,y0] ; [x4,y0] ; [x4,y3] ;...
                        [x01,y3] ; [x2,y2] ; [x0,y2]] + t_xy_common;
