function [V, G, H, Gi, Gd] = createShape_shape29(appData)
    ...
    if(1)
        theta_deg = 90;
        txy = scale_factor * [x1,y8] + t_xy_common;
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x1,y0] ; [x3,y2] ; [x3,y0] ; [x4,y2] ; [x3,y4] ; [x2,y5] ; ...
                        [x2,y7] ; [x1,y8] ; [x0,y6] ; [x1,y6]] + t_xy_common;
