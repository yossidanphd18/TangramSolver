function [V, G, H, Gi, Gd] = createShape_shape44(appData)
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x2,y0] ; [x4,y1] ; [x3,y3]; [x4,y4] ; [x4,y5]; [x6,y5] ; ... 
                        [x4,y8] ; [x5,y9] ; [x2,y9]; [x1,y7] ; [x2,y4]; [x1,y4] ; ... 
                        [x0,y2] ; [x1,y2]; [x2,y4]] + t_xy_common;
