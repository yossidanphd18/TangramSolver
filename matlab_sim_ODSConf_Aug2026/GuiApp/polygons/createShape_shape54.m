function [V, G, H, Gi, Gd] = createShape_shape54(appData)
    ...
    theta_deg = 90;
    txy = scale_factor * [x5,y4] + t_xy_common;
    flip_agnostic = 1;
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x1,y0] ; [x5,y0] ; [x6,y2] ; [x5,y4] ; [x5,y2] ; [x4,y3] ; [x4,y1] ;...
                        [x3,y2] ; [x2,y1] ; [x2,y3] ; [x1,y2] ; [x1,y4] ; [x0,y2]] + t_xy_common;
