function [V, G, H, Gi, Gd] = createShape_shape25(appData)
    ...
    txy = scale_factor * [x3,y5] + t_xy_common;
    ...
    theta_deg = 90;
    txy = scale_factor * [x3,y6] + t_xy_common;
    ...
    theta_deg = 135;
    txy = scale_factor * [x2,y5] + t_xy_common;
    h = (1/4)*scale_factor; w = (1/2)*scale_factor;
    area = (0.5*h*w);
    flip_agnostic = 1;
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x0,y2] ; [x2,y2] ; [x2,y1] ; [x3,y3] ; [x3,y0] ; [x6,y0] ; [x4,y4] ;...
                        [x4,y56] ; [x5,y6] ; [x3,y6] ; [x3,y5] ; [x1,y7] ; [x1,y5] ; ...
                        [x2,y5] ] + t_xy_common;
