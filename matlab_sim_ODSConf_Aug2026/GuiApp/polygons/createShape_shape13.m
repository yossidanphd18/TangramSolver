function [V, G, H, Gi, Gd] = createShape_shape13(appData)
    ...
    txy = scale_factor * [x1,y4] + t_xy_common;
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x0,y0] ; [x1,y0] ; [x1,y1] ; [x3-1/(2*sqrt(2)),y1] ; [x3,y0] ; [x4,y1] ; ...
                        [x3,y2] ; [x3,y4] ; [x1,y4] ; [x3-1/4,y2+1/4] ; [x2,y2] ; [x1,y2] ; ...
                        [x0,y3] ; [x0,y2] ; [x1,y1] ; [x0,y1]] + t_xy_common;
