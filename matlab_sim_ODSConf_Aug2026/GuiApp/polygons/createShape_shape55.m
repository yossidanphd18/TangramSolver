function [V, G, H, Gi, Gd] = createShape_shape55(appData)
    ...
    theta_deg = -90;
    txy = scale_factor * [x7,y0] + t_xy_common;
    h = (1/4)*scale_factor; w = (1/2)*scale_factor;
    area = (0.5*h*w);
    flip_agnostic = 1;
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x0,y0] ; [x1,y2] ; [x2,y1] ; [x4,y1] ; [x5,y2] ; [x7,y0] ;...
                        [x7,y2] ; [x5,y4] ; [x4,y3] ; [x2,y3] ; [x1,y4] ; [x0,y2] ] + t_xy_common;
