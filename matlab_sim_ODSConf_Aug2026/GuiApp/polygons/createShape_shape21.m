function [V, G, H, Gi, Gd] = createShape_shape21(appData)
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x1,y0] ; [x4,y2]; [x8,y2]; [x9,y1] ; [x9,y56]; [x7,y3] ; ... 
                        [x6,y4] ; [x6,y7]; [x6-1/2,y4+1/2]; [x5,y5] ; [x3,y5]; [x2,y6] ; ... 
                        [x0,y6] ; [x3,y2]; [x1,y2]] + t_xy_common;
