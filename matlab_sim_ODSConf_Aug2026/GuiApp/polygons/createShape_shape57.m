function [V, G, H, Gi, Gd] = createShape_shape57(appData)
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x1,y0] ; [x3,y0] ; [x4,y2] ; [x3,y2] ; ...
                        [x5+1/2,y5] ; [x2,y1+1/2] ; [x5,y5] ; ...
                        [x1,y2] ; [x0,y2]] + t_xy_common;
