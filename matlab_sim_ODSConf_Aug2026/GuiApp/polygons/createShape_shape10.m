function [V, G, H, Gi, Gd] = createShape_shape10(appData)
    ...
    theta_deg = -90;
    txy = scale_factor * [x5,y3] + t_xy_common;
    h = (1/4)*scale_factor; w = (1/2)*scale_factor;
    area = (0.5*h*w);
    flip_agnostic = 1;
    ...
    V{k} = {base_vrtxs{k}, theta_deg, txy, area, flip_id, flip_agnostic, 'MediumTriangle', [0.2 0.8 0.6]}; k = k + 1;
     ...
     % The Goal polygon.
    G = scale_factor * [[x1,y0] ; [x5,y0] ; [x4,y2]; [x5,y3] ; [x5,y4]; [x7,y4] ; ... 
                        [x5,y7] ; [x6,y8] ; [x3,y8]; [x2,y6] ; [x3,y3]; [x2,y3] ; ... 
                        [x0,y1] ; [x2,y1]] + t_xy_common;
